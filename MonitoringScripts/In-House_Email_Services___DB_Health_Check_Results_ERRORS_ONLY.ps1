Remove-Item "C:\Scripts\Daily_Checks\Scheduled_Tasks-EMailed_Results\In-House_Email_Services___DB_Health_FAILED_ONLY.htm"
...
$Outputreport = "<HTML><TITLE> In-House Email Services Database Health Check Results - FAILED ONLY </TITLE>
                 <BODY background-color:peachpuff>
                 <font color =""#99000"" face=""Microsoft Tai le"">
                 <H2> In-House Email Services - Database Health Check Results - FAILED ONLY - $ReportDate</H2></font>
...
$DB_Info = Get-MailboxServer | where {($_.name -like "EIS-*-EP0*") -or ($_.name -like "IMG-*-EP*") -or ($_.name -like "DCS-DCB-EP*")} | Get-MailboxDatabaseCopyStatus | where {($_.Status -like "Failed") -or ($_.Status -like "ServiceDown") -or ($_.ContentIndexState -like "Failed")} | sort Name
...
$Outputreport | out-file "C:\Scripts\Daily_Checks\Scheduled_Tasks-EMailed_Results\In-House_Email_Services___DB_Health_FAILED_ONLY.htm"
...
$EMailAttachment = "C:\Scripts\Daily_Checks\Scheduled_Tasks-EMailed_Results\In-House_Email_Services___DB_Health_FAILED_ONLY.htm"
...
$Subject = "In-House Email Services - Database Health Check Results - FAILED ONLY"
