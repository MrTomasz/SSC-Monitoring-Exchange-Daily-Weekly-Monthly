...
$Outputreport | out-file C:\Scripts\MonitoringScripts\In-House_Email_Services___CPU_Health_Report.htm
...
$EMailAttachment = "C:\Scripts\MonitoringScripts\In-House_Email_Services___CPU_Health_Report.htm"
